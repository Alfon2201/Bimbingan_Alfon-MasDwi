                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="level" class="form-control">
                                                    ...
                                                    <option value="Admin" value=<?=set_value('level') == "Admin" ? "selected"  : null?>>Admin</option>
                                                    <option value="Pegawai"value=<?=set_value('level') == "Pegawai" ? "selected"  : null?>>Pegawai</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="no" value="<?=set_value('no')?>" class="form-control">  
                                            </div>
                                        </div>
