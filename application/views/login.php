...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url() ?>assets/css/pages/login/login-4.css?v=7.2.9" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
					...
					<div class="login-content d-flex flex-column pt-lg-0 pt-12">
						...
						<a href="#" class="login-logo pb-xl-20 pb-15">
							<img src="<?php echo base_url() ?>assets/media/logos/logo-4.png" class="max-h-70px" alt="" />
						</a>
						<!--end::Logo-->
						<!--begin::Signin-->
							...
							<form class="form" id="kt_login_singin_form" action="">
								...
								<div class="pb-lg-0 pb-5">
									...
									<span class="svg-icon svg-icon-md">
										<!--begin::Svg Icon | path:<?php echo base_url() ?>assets/media/svg/social-icons/google.svg-->
				...
				<div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
					<div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom" style="background-image: url(<?php echo base_url() ?>assets/media/svg/illustrations/login-visual-4.svg);">
						<!--begin::Aside title-->
		...
		<script src="<?php echo base_url() ?>assets/js/pages/custom/login/login-4.js?v=7.2.9"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>